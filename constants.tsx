...
export const CATEGORIES = [
  ...
  { title: "Coloring Books", desc: "Print-at-home resources and activity packs.", icon: BookOpen, color: "bg-secondary", bg: "bg-yellow-50", path: "/products?category=ColoringBooks" },
...
export const FEATURED_PRODUCTS: Product[] = [
  ...
  { id: 2, title: "Lumasha Coloring Books", category: "ColoringBooks", price: "$3.97 USD", image: "/assets/Easter.png", badge: "New", badgeColor: "bg-primary text-white", rating: 4, reviews: 32, path: "/products?category=ColoringBooks" },
...
export const ALL_PRODUCTS: Product[] = [
  ...
  { id: 4, title: "Easter Coloring Book for Kids Ages 4-10 | Printable Bunny Egg Activity Pages (PDF)", category: "ColoringBooks", price: "$3.97USD", image: "/assets/Easter.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 30 },
  { id: 5, title: "Healthy Habits Coloring Book for Kids | Daily Routine Activity Workbook Ages 4-10 (Printable)", category: "ColoringBooks", price: "$3.97USD", image: "/assets/Healthyhabbits.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 25 },
  { id: 6, title: "Maha Shivaratri Kids Book | Lord Shiva Story, Hindu Festival (Digital PDF)", category: "StoryBooks", price: "$6.97USD", image: "/assets/Shivaratri.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 20 },
  { id: 7, title: "Little Ganesh – A Children’s Story of Courage, Love & New Beginnings | Hindu Mythology Kids Book | Cultural Storybook | Digital Books(Digital Download)", category: "StoryBooks", price: "$6.97USD", image: "/assets/ganesh.jpg", badge: "New", badgeColor: "bg-primary text-white", rating: 4, reviews: 32 },
  { id: 8, title: "Saraswati Puja Storybook | Hindu Culture for Kids (Digital Download)", category: "StoryBooks", price: "$6.97USD", image: "/assets/Sarswatipuja.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 9, title: "Why we Celebrate Christmas? | A Fun Christian Christmas Story for Kids (Ages 3–8) | Printable Digital Book (Digital Download)", category: "StoryBooks", price: "$6.97USD", image: "/assets/Christmas.png", badge: "Bestseller", badgeColor: "bg-secondary text-neutral-dark", rating: 5, reviews: 48 },
  { id: 10, title: "Dashain Durga Storybook Kids | Illustrated Learning for Kids(Digital Download)", category: "StoryBooks", price: "$6.97USD", image: "/assets/DashainandDurga.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 11, title: "Lakshmi Puja Book for Kids, Cultural & Educational Digital PDF(Digital Download)", category: "StoryBooks", price: "$6.97USD", image: "/assets/LaxmiPuja.png", badge: "Bestseller", badgeColor: "bg-secondary text-neutral-dark", rating: 5, reviews: 48 },
  { id: 12, title: "Persian Alphabet Flashcards: Farsi Learning Cards, Montessori Printable (Digital Download))", category: "EBooks", price: "$3.97USD", image: "/assets/Persianpdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 4, reviews: 32 },
  { id: 13, title: "Gujarati Alphabet Flashcards: Montessori Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Gujratipdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 14, title: "Nepali Language Flashcards: Montessori Learning Cards with Devanagari Script (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Nepalipdf.png", badge: "Bestseller", badgeColor: "bg-secondary text-neutral-dark", rating: 5, reviews: 48 },
  { id: 15, title: "Punjabi Alphabet Flashcards: Punjabi Learning Cards, Montessori Printable (Digital Download))", category: "EBooks", price: "$3.97USD", image: "/assets/Punjabipdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 4, reviews: 32 },
  { id: 16, title: "Hindi Flashcards: Montessori Printable Learning Cards with Pronunciation (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Hindipdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 17, title: "English Alphabet Flashcards: Montessori Printable Learning Cards (Digital Download))", category: "EBooks", price: "$3.97USD", image: "/assets/Englishpdf.png", badge: "Bestseller", badgeColor: "bg-secondary text-neutral-dark", rating: 5, reviews: 48 },
  { id: 18, title: "Filipino Language Flashcards: Montessori Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Filipinopdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 4, reviews: 32 },
  { id: 19, title: "Kannada Language Flashcards: Montessori Learning Cards for Kids (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Kannadapdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 20, title: "French Alphabet Flashcards: Montessori Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Frenchpdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 21, title: "Korean Alphabet Flashcards: Montessori Learning Cards (Digital Download PDF)", category: "EBooks", price: "$3.97USD", image: "/assets/Koreanpdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 22, title: "Portuguese Language Flashcards: Montessori Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Portugesepdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 23, title: "Printable Punjabi Number Flashcards: Gurmukhi Numerics 1-20 (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Punjabinumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 24, title: "Spanish Numbers Flashcards 1-9: Montessori Printable Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Spanishnumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 25, title: "Gujarati Numbers Flashcards 1-9: Bilingual Learning Cards (PDF Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Gujaratinumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 26, title: "English Number Flashcards 1-9: Montessori Printable (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Englishnumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 27, title: "French Number Flashcards 1-9: Bilingual Learning Cards (Digital Download)", category: "EBooks", price: "$3.97USD", image: "/assets/Frenchnumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 28, title: "Nepali Numbers Flashcards: Devanagari Script, Pronunciation Guide (Digital Download, PDF)", category: "EBooks", price: "$3.97USD", image: "/assets/Nepalinumberspdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
  { id: 29, title: "Spanish Alphabet Flashcards: Montessori Learning Cards (Digital Download PDF)", category: "EBooks", price: "$3.97USD", image: "/assets/Spanishpdf.png", badge: "New", badgeColor: "bg-primary text-white", rating: 5, reviews: 15 },
];
