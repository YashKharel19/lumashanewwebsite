...
const ColorHunt = () => {
    ...
    const sentences: Record<string, (color: string) => string> = {
        ...
        Nepali: (c) => `${c} रंग पत्ता लगाउनुहोस्`,
                    ...
                    {cards.map((card) => (
                        ...
                        >
                            ...
                            <div className={`absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl bg-accent text-white flex flex-col items-center justify-center p-2 shadow-lg overflow-hidden`}>
                                ...
                                <span className="text-xl xl:text-base font-bold uppercase tracking-tight truncate w-full text-center mt-1 px-1">
...
const QuizWhiz = () => {
    ...
    const questionsMap: Record<string, any[]> = {
        ...
        Nepali: [
            { q: "“Apple” लाई नेपालीमा के भनिन्छ?", options: ["केरा", "स्याउ", "आँप", "कागती"], a: "स्याउ" },
            { q: "“Water” लाई नेपालीमा के भनिन्छ?", options: ["दूध", "चिया", "रस", "पानी"], a: "पानी" },
            { q: "“Bag” लाई नेपालीमा के भनिन्छ?", options: ["किताब", "झोला", "माछा", "गाडी"], a: "झोला" },
            ...
            { q: "“झ” बाट सुरु हुने कुन शब्द हो?", options: ["झोला", "गाडी", "स्याउ", "आँप"], a: "झोला" },
            { q: "“क” बाट सुरु हुने कुन शब्द हो?", options: ["किताब", "आँप", "झोला", "घर"], a: "किताब" },
            ...
            { q: "कुन जनावरले गाजर खान्छ?", options: ["भालु", "खरायो", "कुकुर", "सुँगुर"], a: "खरायो" },
        ],
        Hindi: [
